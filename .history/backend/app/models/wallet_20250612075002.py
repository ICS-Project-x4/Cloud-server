...
class Transaction(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    wallet_id = Column(Integer, ForeignKey("wallets.id"), nullable=True)  # Make it nullable
    ...
    wallet = relationship("Wallet", back_populates="transactions", nullable=True)  # Make relationship nullable 